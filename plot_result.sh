...
gnuplot -e "set style line 1 lc rgb 'black' pt 5; set terminal png; set output 'result.png'; set xlabel '#threads'; set ylabel 'bandwidth(GB/s)'; plot for[col=2:2] 'README.md' using 1:col title columnheader(col) with lines;"
